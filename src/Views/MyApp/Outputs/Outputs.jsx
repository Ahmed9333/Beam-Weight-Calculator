          ...
          >
            <div>
              ...
              <OutputElem 
                data={outputsData.V}
                inputsData={inputsData}
                calculationFunctions={calculationFunctions.volume}
              />
              <OutputElem 
                data={outputsData.M}
                inputsData={inputsData}
                calculationFunctions={calculationFunctions.masse}
              />
            </div>
          </CardElem>
        </Grid>
            ...
            <div>
              <TableElem
                data={{
                  ...
                  rows: [
                    {x: 0, y: 0, z: 0},
                    {x: inputsData.b.value, y: 0, z: 0},
                    {x: inputsData.b.value, y: inputsData.h.value, z: 0},
                    {x: 0, y: inputsData.h.value, z: 0},
                    {x: 0, y: 0, z: inputsData.L.value},
                    {x: inputsData.b.value, y: 0, z: inputsData.L.value},
                    {x: inputsData.b.value, y: inputsData.h.value, z: inputsData.L.value},
                    {x: 0, y: inputsData.h.value, z: inputsData.L.value}
                  ],
                  unit: {x: 'm', y: 'm', z:'m'}
                }}
              />
